...
interface FarmInterface extends ethers.utils.Interface {
  ...
  events: {
    ...
    "SetTokenPerBlock(uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "SetTokenPerBlock"): EventFragment;
...
export type SetTokenPerBlockEvent = TypedEvent<
...
export class Farm extends BaseContract {
  ...
  functions: {
    ...
    poolInfo(
      ...
      [string, BigNumber, BigNumber, BigNumber, BigNumber] & {
        ...
        accTokenPerShareTilBonusEnd: BigNumber;
      }
    >;
  ...
  filters: {
    ...
    "SetTokenPerBlock(uint256)"(
      tokenPerBlock?: BigNumberish | null
